...
# ============================================
# 🔹 Fonctions de calcul des critères principaux
# ============================================
...
# ====================================
# 🔹 Calcul global de tous les scores
# ====================================

def compute_scores(df):
    # Correspondance explicite avec tes colonnes
    mapping = {
...
# ====================================
# 🔹 Lancer le calcul et exporter
# ====================================

df = compute_scores(df)
df.head(10)

df.to_excel("resultats_scores.xlsx", index=False)
from google.colab import files
files.download("resultats_scores.xlsx")
print("Fichier 'resultats_scores.xlsx' prêt au téléchargement.")